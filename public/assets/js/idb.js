...
function uploadPizza() {
  ...
  getAll.onsuccess = function () {
    ...
    /*
    Fortunately, the Mongoose .create() method we use to create a pizza 
    can handle either single objects or an array of objects, 
    so no need to create another route and controller method to handle this one event.
    */
